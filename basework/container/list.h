...
#ifndef __WRITE_ONCE
#define __WRITE_ONCE(p, v) (p) = (v)
#endif

#ifndef __READ_ONCE
#define __READ_ONCE(p) (p)
#endif
			      ...
			      struct list_head *next)
{
	...
	newn->next = next;
	newn->prev = prev;
	__WRITE_ONCE(prev->next, newn);
}

/**
 * list_add - add a newn entry
...
/**
 * list_add_tail - add a newn entry
 * @newn: newn entry to be added
...
/**
 * list_replace - replace old entry by newn one
...
{
	return __READ_ONCE(head->next) == head;
}
...
#define list_first_entry_or_null(ptr, type, member) ({ \
	...
	struct list_head *pos__ = __READ_ONCE(head__->next); \
